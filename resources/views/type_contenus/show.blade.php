...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
    <div class="flex items-center mb-4 sm:mb-0">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Détails du Type de Contenu</h1>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-green-50 px-6 py-5 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center mb-4 sm:mb-0">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-gray-900">{{ $typeContenu->nom_contenu }}</h2>
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="space-y-4">
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900 mt-1">#{{ $typeContenu->id_type_contenu }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900 mt-1">{{ $typeContenu->nom_contenu }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div>
                                <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Nombre de contenus</h3>
                                <p class="text-lg font-semibold text-gray-900 mt-1">{{ $typeContenu->contenus->count() }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900 mt-1">{{ $typeContenu->created_at->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                        ...
                        Contenus associés ({{ $typeContenu->contenus->count() }})
                    </h3>
                ...
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-600 mb-4">Aucun contenu n'est associé à ce type pour le moment.</p>
            ...
            <div class="p-6">
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span class="text-sm font-semibold text-gray-900">
                            {{ $typeContenu->updated_at ? $typeContenu->updated_at->format('d/m/Y à H:i') : 'Non modifié' }}
                        </span>
                    </div>
            ...
            <div class="p-6">
                <div class="space-y-4">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-600 mb-1">{{ $typeContenu->contenus->count() }}</div>
                        <div class="text-sm text-gray-600">Contenus total</div>
                    </div>
                    
                    @if($typeContenu->contenus->count() > 0)
                    @php
                        $valides = $typeContenu->contenus->where('statut', 'valide')->count();
                        $enAttente = $typeContenu->contenus->where('statut', 'en_attente')->count();
                        $rejetes = $typeContenu->contenus->where('statut', 'rejete')->count();
                    @endphp
                    <div class="space-y-2">
