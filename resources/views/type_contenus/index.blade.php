...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
    <div class="flex items-center mb-4 sm:mb-0">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Types de Contenu</h1>
            <p class="text-gray-600 mt-1">Catégories de contenus culturels du Bénin</p>
        </div>
    </div>
        ...
        <ol class="inline-flex items-center space-x-2 text-sm">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-blue-600 font-medium">Types de Contenu</span>
                </div>
            </li>
        </ol>
    </nav>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <a href="{{ route('admin.type-contenus.create') }}" 
    ...
    <div class="p-6">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="text-sm font-mono font-bold text-gray-900">#{{ $type->id_type_contenu }}</div>
                        </td>
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="text-sm font-semibold text-gray-900">{{ $type->nom_contenu }}</div>
                            </div>
                        </td>
                        <td class="px-6 py-3 whitespace-nowrap">
                        ...
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ route('admin.type-contenus.show', $type->id_type_contenu) }}" 
                                ...
                                <a href="{{ route('admin.type-contenus.edit', $type->id_type_contenu) }}" 
                                ...
                                <form action="{{ route('admin.type-contenus.destroy', $type->id_type_contenu) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
                                            ...
                                            onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce type de contenu ?')"
                                            title="Supprimer">
        ...
        <div class="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm text-gray-600">
            <div class="flex items-center mb-3 sm:mb-0">
                ...
                <span class="font-medium">{{ $typeContenus->count() }} type(s) de contenu enregistré(s)</span>
            </div>
            <div class="flex items-center">
...
$(document).ready(function() {
    ...
    console.log("DataTables types de contenu initialisé avec succès !");
});
</script>
