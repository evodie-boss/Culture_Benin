...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
    <div class="flex items-center mb-4 sm:mb-0">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Types de Media</h1>
            <p class="text-gray-600 mt-1">Catégories de médias culturels du Bénin</p>
        </div>
    </div>
        ...
        <ol class="inline-flex items-center space-x-2 text-sm">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-blue-600 font-medium">Types de Media</span>
                </div>
            </li>
        </ol>
    </nav>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <a href="{{ route('admin.type-medias.create') }}" 
    ...
    <div class="p-6">
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
            <table id="typesTable" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                            <div class="flex items-center">
                                <i class="fas fa-photo-video mr-2 text-gray-500 text-xs"></i>
                                Nombre de Medias
                            </div>
                        </th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="text-sm font-mono font-bold text-gray-900">#{{ $type->id_type_media }}</div>
                        </td>
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="bg-blue-100 p-1 rounded-lg mr-3">
                                    <i class="fas fa-photo-video text-blue-600 text-xs"></i>
                                </div>
                                <div class="text-sm font-semibold text-gray-900">{{ $type->nom_media }}</div>
                            </div>
                        </td>
                        <td class="px-6 py-3 whitespace-nowrap">
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                <i class="fas fa-file-image mr-1 text-xs"></i>
                                {{ $type->medias->count() }} medias
                            </span>
                        </td>
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                <!-- Bouton Voir - ICÔNE SEULEMENT -->
                                <a href="{{ route('admin.type-medias.show', $type->id_type_media) }}" 
                                ...
                                <a href="{{ route('admin.type-medias.edit', $type->id_type_media) }}" 
                                ...
                                <form action="{{ route('admin.type-medias.destroy', $type->id_type_media) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
                                            ...
                                            onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce type de media ?')"
                                            title="Supprimer">
        ...
        <div class="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm text-gray-600">
            <div class="flex items-center mb-3 sm:mb-0">
                ...
                <span class="font-medium">{{ $typeMedias->count() }} type(s) de media enregistré(s)</span>
            </div>
            <div class="flex items-center">
...
$(document).ready(function() {
    ...
    console.log("DataTables types de media initialisé avec succès !");
});
</script>
