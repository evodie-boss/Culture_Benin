...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
    <div class="flex items-center mb-4 sm:mb-0">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Ajouter une Langue</h1>
            <p class="text-gray-600 mt-1">Nouvelle langue béninoise</p>
        </div>
    </div>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-green-50 px-6 py-5 border-b border-gray-200">
        <div class="flex items-center">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-900">Nouvelle Langue Béninoise</h2>
                <p class="text-gray-600 mt-2">Ajoutez une nouvelle langue à la plateforme culturelle</p>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-3 mb-6">
                ...
                <div class="relative">
                    ...
                    <textarea class="pl-12 w-full rounded-xl border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('description') border-red-500 @enderror" 
                              ...
                              name="description" 
                              rows="5" 
                              placeholder="Décrivez cette langue : localisation, nombre de locuteurs, particularités...">{{ old('description') }}</textarea>
                </div>
                @error('description')
                    <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                @enderror
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        const nomLangue = document.getElementById('nom_langue').value;
        const codeLangue = document.getElementById('code_langue').value;
        
        if (!nomLangue || !codeLangue) {
            e.preventDefault();
