...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
    <div class="flex items-center mb-4 sm:mb-0">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Liste complète des régions du Bénin</p>
        </div>
    </div>
        ...
        <ol class="inline-flex items-center space-x-2 text-sm">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-blue-600 font-medium">Régions</span>
                </div>
            </li>
        </ol>
    </nav>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
    ...
    <div class="p-6">
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
            <table id="regionsTable" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                            <div class="flex items-center">
                                <i class="fas fa-location-arrow mr-2 text-gray-500 text-xs"></i>
                                Localisation
                            </div>
                        </th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                            <div class="flex items-center">
                                <i class="fas fa-ruler-combined mr-2 text-gray-500 text-xs"></i>
                                Superficie (km²)
                            </div>
                        </th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="text-sm font-mono font-bold text-gray-900">#{{ $region->id_region }}</div>
                        </td>
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="text-sm font-semibold text-gray-900">{{ $region->nom_region }}</div>
                            </div>
                        </td>
                        <td class="px-6 py-3 whitespace-nowrap">
                        ...
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                ...
                                <form action="{{ route('admin.regions.destroy', $region->id_region) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
        ...
        <div class="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm text-gray-600">
            <div class="flex items-center mb-3 sm:mb-0">
                ...
                <span class="font-medium">{{ $regions->count() }} région(s) enregistrée(s)</span>
            </div>
            <div class="flex items-center">
...
$(document).ready(function() {
    ...
    console.log("DataTables régions initialisé avec succès !");
});
</script>
