...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
    <div class="flex items-center mb-4 sm:mb-0">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Informations complètes sur cette région</p>
        </div>
    </div>
        ...
        <ol class="inline-flex items-center space-x-2 text-sm">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('admin.regions.index') }}" class="ml-1 text-gray-500 hover:text-blue-600">Régions</a>
                </div>
            </li>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-green-50 px-6 py-5 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center mb-4 sm:mb-0">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-gray-900">{{ $region->nom_region }}</h2>
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="space-y-4">
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900 mt-1">#{{ $region->id_region }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900 mt-1">{{ $region->nom_region }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div>
                                <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Localisation</h3>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div>
                                <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Population</h3>
                                <p class="text-lg font-semibold text-gray-900 mt-1">
                                    {{ $region->population ? number_format($region->population, 0, ',', ' ') : 'Non renseignée' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            <div class="bg-indigo-100 p-3 rounded-lg mr-4">
                                <i class="fas fa-ruler-combined text-indigo-600 text-lg"></i>
                            </div>
                            <div>
                                <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Superficie</h3>
                                <p class="text-lg font-semibold text-gray-900 mt-1">
                                    {{ $region->superficie ? number_format($region->superficie, 0, ',', ' ') . ' km²' : 'Non renseignée' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            <div class="bg-teal-100 p-3 rounded-lg mr-4">
                                <i class="fas fa-align-left text-teal-600 text-lg"></i>
                            </div>
                            <div>
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                        ...
                        Contenus associés ({{ $region->contenus->count() }})
                    </h3>
                ...
                <div class="text-center py-8">
                    ...
                    <h4 class="text-lg font-semibold text-gray-900 mb-2">Aucun contenu associé</h4>
                    <p class="text-gray-600 mb-4">Aucun contenu n'est associé à cette région pour le moment.</p>
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span class="text-sm font-semibold text-gray-900">
                            {{ $region->created_at ? $region->created_at->format('d/m/Y à H:i') : 'N/A' }}
                        </span>
                    </div>
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span class="text-sm font-semibold text-gray-900">
                            {{ $region->updated_at ? $region->updated_at->format('d/m/Y à H:i') : 'Non modifié' }}
                        </span>
                    </div>
            ...
            <div class="p-6">
                <div class="space-y-4">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-600 mb-1">{{ $region->contenus->count() }}</div>
                        <div class="text-sm text-gray-600">Contenus total</div>
                    </div>
                    
                    @if($region->contenus->count() > 0)
                    @php
                        $valides = $region->contenus->where('statut', 'valide')->count();
                        $enAttente = $region->contenus->where('statut', 'en_attente')->count();
                        $rejetes = $region->contenus->where('statut', 'rejete')->count();
                    @endphp
                    <div class="space-y-2">
                        <div class="flex justify-between text-sm">
                            <span class="text-green-600">Validés</span>
                            <span class="font-semibold">{{ $valides }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-yellow-600">En attente</span>
                            <span class="font-semibold">{{ $enAttente }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-red-600">Rejetés</span>
                            <span class="font-semibold">{{ $rejetes }}</span>
                        </div>
                    </div>
                    @endif
                </div>
